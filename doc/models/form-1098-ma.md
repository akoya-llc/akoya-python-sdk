...
| `total_mortgage_payments` | `float` | Optional | Box 1, Total State HFA (Housing Finance Agency) and homeowner mortgage payments |
| `mortgage_assistance_payments` | `float` | Optional | Box 2, State HFA (Housing Finance Agency) mortgage assistance payments |
| `homeowner_mortgage_payments` | `float` | Optional | Box 3, Homeowner mortgage payments |
