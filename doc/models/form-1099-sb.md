...
| `contract_investment` | `float` | Optional | Box 1, Investment in contract |
| `surrender_amount` | `float` | Optional | Box 2, Surrender amount |
| `contact_name_address` | [`NameAddressAndPhone`](../../doc/models/name-address-and-phone.md) | Optional | Issuer's information contact name, street address, city or town, state or province, country, ZIP or foreign postal code, and telephone no. (if different from ISSUER) |
