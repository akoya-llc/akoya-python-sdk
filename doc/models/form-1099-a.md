...
| `date_of_acquisition` | `date` | Optional | Box 1, Date of lender's acquisition or knowledge of abandonment |
| `principal_balance` | `float` | Optional | Box 2, Balance of principal outstanding |
| `fair_market_value` | `float` | Optional | Box 4, Fair market value property |
| `personally_liable` | `bool` | Optional | Box 5, If checked, the borrower was personally liable for repayment of the debt |
| `property_description` | `str` | Optional | Box 6, Description of property |
