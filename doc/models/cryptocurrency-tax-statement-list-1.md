...
# Cryptocurrency Tax Statement List 1
...
| `gains_and_losses` | [`List[GainOrLossFromCryptocurrencyTransaction]`](../../doc/models/gain-or-loss-from-cryptocurrency-transaction.md) | Optional | The list of cryptocurrency gains and losses |
