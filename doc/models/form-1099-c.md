...
| `date_of_event` | `date` | Optional | Box 1, Date of identifiable event |
| `amount_discharged` | `float` | Optional | Box 2, Amount of debt discharged |
| `interest_included` | `float` | Optional | Box 3, Interest if included in box 2 |
| `debt_description` | `str` | Optional | Box 4, Debt description |
| `personally_liable` | `bool` | Optional | Box 5, If checked, the debtor was personally liable for repayment of the debt |
| `debt_code` | `str` | Optional | Box 6, Identifiable debt code |
| `fair_market_value` | `float` | Optional | Box 7, Fair market value of property |
