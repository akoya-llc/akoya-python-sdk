...
# Form 1099 Consolidated Statement
...
| `margin_interest_paid` | `float` | Optional | Interest paid on margin account |
| `payment_in_lieu_paid` | `float` | Optional | Payment in lieu of dividends paid |
| `advisor_fees_paid` | `float` | Optional | Advisor fees paid |
| `other_fees_paid` | `float` | Optional | Other fees paid |
| `corporate_bond_interest_paid` | `float` | Optional | Accrued Interest Paid offset to form 1099-INT box 1, Corporate bond interest income |
| `us_bond_interest_paid` | `float` | Optional | Accrued Interest Paid offset to form 1099-INT box 3, accrued U.S. Treasury Notes and Bonds interest income |
| `tax_exempt_interest_paid` | `float` | Optional | Accrued Interest Paid offset to form 1099-INT box 8, tax exempt interest income from municipal bonds |
| `specified_pab_interest_paid` | `float` | Optional | Accrued Interest Paid offset to form 1099-INT box 9, tax exempt interest income from Private Activity Bonds |
