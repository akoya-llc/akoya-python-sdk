...
| `self_insured_coverage` | `bool` | Optional | Self Insured Coverage |
| `offers_of_coverage` | [`List[OfferOfHealthInsuranceCoverage]`](../../doc/models/offer-of-health-insurance-coverage.md) | Optional | Boxes 14-16, Employee Offer of Coverage |
| `employee_age` | `int` | Optional | Employee's Age on January 1 |
| `plan_start_month` | `int` | Optional | Plan Start Month |
| `covered_individuals` | [`List[HealthInsuranceMarketplaceCoveredIndividual]`](../../doc/models/health-insurance-marketplace-covered-individual.md) | Optional | Boxes 17+, Covered Individuals |
