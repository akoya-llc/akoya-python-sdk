...
| `earnings` | `float` | Optional | Box 2, Earnings on excess contributions |
| `distribution_code` | `str` | Optional | Box 3, Distribution code |
| `fair_market_value` | `float` | Optional | Box 4, FMV on date of death |
| `hsa` | `bool` | Optional | Box 5a, HSA |
| `archer_account` | `bool` | Optional | Box 5b, Archer MSA |
| `medical_savings_account` | `bool` | Optional | Box 5c, Medicare Advantage (MA) MSA |
