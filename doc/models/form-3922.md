...
| `grant_market_value` | `float` | Optional | Box 3, Fair market value per share on grant date |
| `exercise_market_value` | `float` | Optional | Box 4, Fair market value per share on exercise date |
| `exercise_price` | `float` | Optional | Box 5, Exercise price paid per share |
| `number_of_shares` | `float` | Optional | Box 6, Number of shares transferred |
| `title_transfer_date` | `date` | Optional | Box 7, Date legal title transferred |
| `grant_date_exercise_price` | `float` | Optional | Box 8, Exercise price per share determined as if the option was exercised on the option granted date |
