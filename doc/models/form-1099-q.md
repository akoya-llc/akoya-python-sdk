...
| `earnings` | `float` | Optional | Box 2, Earnings |
| `basis` | `float` | Optional | Box 3, Basis |
| `trustee_to_trustee` | `bool` | Optional | Box 4, Trustee-to-trustee transfer |
| `tuition_plan_private` | `bool` | Optional | Box 5a, Qualified tuition plan - Private |
| `tuition_plan_public` | `bool` | Optional | Box 5b, Qualified tuition plan - Public |
| `coverdell_esa` | `bool` | Optional | Box 5c, Coverdell ESA |
| `recipient_is_not_beneficiary` | `bool` | Optional | Box 6, If this box is checked, the recipient is not the designated beneficiary |
| `fair_market_value` | `float` | Optional | If fair market value (FMV) is included, see Pub. 970, Tax Benefits for Education, for how to figure earnings |
