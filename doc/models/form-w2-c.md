...
| `corrected_tin_or_name` | `bool` | Optional | Box e, Corrected SSN and/or name |
| `previous_employee_tin` | `str` | Optional | Box f, Employee's previously reported SSN |
| `previous_employee_name` | [`IndividualName`](../../doc/models/individual-name.md) | Optional | Box g, Employee's previously reported name |
| `original_w_2` | [`FormW2`](../../doc/models/form-w2.md) | Optional | Boxes 1-20 of Previously reported Wage and Tax Statement |
| `corrected_w_2` | [`FormW2`](../../doc/models/form-w2.md) | Optional | Boxes 1-20 of Correct information Wage and Tax Statement |
