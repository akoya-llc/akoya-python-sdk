...
| `date_of_sale` | `date` | Optional | Box 1, Date of sale or exchange |
| `aggregate_amount` | `float` | Optional | Box 2, Aggregate amount received |
| `number_of_shares` | `float` | Optional | Box 3, Number of shares exchanged |
| `stock_classes` | `str` | Optional | Box 4, Classes of stock exchanged |
