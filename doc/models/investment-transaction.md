...
| `income_type` | [`IncomeTypeEnum`](../../doc/models/income-type-enum.md) | Optional | Type of investment income. CGLONG (capital gains-long term), CGSHORT (capital gains-short term), MISC. |
...
| `security_id_type` | [`InvestmentTransactionSecurityIdTypeEnum`](../../doc/models/investment-transaction-security-id-type-enum.md) | Optional | Security identifier type. |
| `security_type` | [`SecurityTypeEnum`](../../doc/models/security-type-enum.md) | Optional | - |
...
| `sub_account_fund` | [`SubAccountFundEnum`](../../doc/models/sub-account-fund-enum.md) | Optional | From which account money came in. |
| `sub_account_sec` | [`SubAccountSecurityTypeEnum`](../../doc/models/sub-account-security-type-enum.md) | Optional | Sub-account security type. |
...
| `transaction_reason` | [`TransactionReasonEnum`](../../doc/models/transaction-reason-enum.md) | Optional | Reason for this transaction; CALL (the debt was called), SELL (the debt was sold), MATURITY (the debt reached maturity) |
| `transaction_type` | [`InvestmentTransactionTypeEnum`](../../doc/models/investment-transaction-type-enum.md) | Optional | InvestmentTransaction Type |
| `transfer_action` | [`TransferActionEnum`](../../doc/models/transfer-action-enum.md) | Optional | Transfer direction. |
