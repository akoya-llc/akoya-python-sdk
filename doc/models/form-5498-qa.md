...
| `able_contributions` | `float` | Optional | Box 1, ABLE contributions |
| `rollovers` | `float` | Optional | Box 2, ABLE to ABLE Rollovers |
| `cumulative_contributions` | `float` | Optional | Box 3, Cumulative contributions |
| `fair_market_value` | `float` | Optional | Box 4, Fair market value |
| `opened_in_tax_year` | `bool` | Optional | Box 5, Check if account opened in current tax year |
| `basis_of_disability_code` | `str` | Optional | Box 6, Basis of eligibility |
| `type_of_disability_code` | `str` | Optional | Box 7, Code |
