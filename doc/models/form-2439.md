...
| `undistributed_long_term_capital_gains` | `float` | Optional | Box 1a, Total undistributed long-term capital gains |
| `unrecaptured_1250_gain` | `float` | Optional | Box 1b, Unrecaptured section 1250 gain |
| `section_1202_gain` | `float` | Optional | Box 1c, Section 1202 gain |
| `collectibles_gain` | `float` | Optional | Box 1d, Collectibles (28%) gain |
| `tax_paid` | `float` | Optional | Box 2, Tax paid by the RIC or REIT on the box 1a gains |
