...
| `advance_payments` | `float` | Optional | Box 1, Amount of HCTC advance payments |
| `number_of_months` | `int` | Optional | Box 2, Number of months HCTC advance payments and reimbursement credits paid to you |
| `payments` | [`List[MonthAndAmount]`](../../doc/models/month-and-amount.md) | Optional | Boxes 3-14, Payments by month |
