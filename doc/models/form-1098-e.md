...
| `student_loan_interest` | `float` | Optional | Box 1, Student loan interest received by lender |
| `box_1_excludes_fees` | `bool` | Optional | Box 2, If checked, box 1 does not include loan origination fee made before September 1, 2004 |
