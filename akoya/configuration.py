...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        authorization_code_auth_credentials = authorization_code_auth_credentials or self.authorization_code_auth_credentials
    ...
    environments = {
        Environment.SANDBOX: {
            ...
            Server.AUTH_SERVER: 'https://sandbox-idp.ddp.akoya.com'
        },
