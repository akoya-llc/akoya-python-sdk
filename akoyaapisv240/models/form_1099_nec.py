...
class Form1099NEC(object):

    """Implementation of the 'Form 1099-NEC' model.
    ...
    Attributes:
        ...
        non_employee_compensation (float): Box 1, Nonemployee compensation
        payer_direct_sales (bool): Box 2, Payer made direct sales of $5,000 or
            more of consumer products to a buyer (recipient) for resale
        federal_tax_withheld (float): Box 4, Federal income tax withheld
        state_and_local (List[StateAndLocalTaxWithholding]): Boxes 5-7, State
    ...
    _names = {
        ...
        "non_employee_compensation": 'nonEmployeeCompensation',
    ...
    def __init__(self,
        ...
        if non_employee_compensation is not APIHelper.SKIP:
            self.non_employee_compensation = non_employee_compensation 
    ...
    def from_dictionary(cls,
        ...
        non_employee_compensation = dictionary.get("nonEmployeeCompensation") if dictionary.get("nonEmployeeCompensation") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'non_employee_compensation={(self.non_employee_compensation if hasattr(self, "non_employee_compensation") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'non_employee_compensation={(self.non_employee_compensation if hasattr(self, "non_employee_compensation") else None)!s}, '
