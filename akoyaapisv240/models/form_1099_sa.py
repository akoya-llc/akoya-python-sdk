...
class Form1099SA(object):
    ...
    Attributes:
        ...
        earnings (float): Box 2, Earnings on excess contributions
        distribution_code (str): Box 3, Distribution code
        fair_market_value (float): Box 4, FMV on date of death
        hsa (bool): Box 5a, HSA
    ...
    _names = {
        ...
        "hsa": 'hsa',
        "archer_account": 'archerAccount',
        "medical_savings_account": 'medicalSavingsAccount'
    }
    ...
    def __init__(self,
                 ...
                 distribution_code=APIHelper.SKIP,
        ...
        if distribution_code is not APIHelper.SKIP:
        ...
        if hsa is not APIHelper.SKIP:
            self.hsa = hsa 
        if archer_account is not APIHelper.SKIP:
            self.archer_account = archer_account 
    ...
    def from_dictionary(cls,
        ...
        distribution_code = dictionary.get("distributionCode") if dictionary.get("distributionCode") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'distribution_code={(self.distribution_code if hasattr(self, "distribution_code") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'distribution_code={(self.distribution_code if hasattr(self, "distribution_code") else None)!s}, '
