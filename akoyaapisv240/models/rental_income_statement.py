...
from akoyaapisv240.models.address import Address
...
class RentalIncomeStatement(object):

    """Implementation of the 'Rental Income Statement' model.
    ...
    Attributes:
        ...
        rents (float): Box 3, Rents received
        ...
        depreciation_expense (float): Box 18, Depreciation
    ...
    def __init__(self,
                 ...
                 depreciation_expense=APIHelper.SKIP,
                 other_expenses=APIHelper.SKIP,
                 capital_expenditures=APIHelper.SKIP):
        """Constructor for the RentalIncomeStatement class"""
        ...
        if depreciation_expense is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        depreciation_expense = dictionary.get("depreciationExpense") if dictionary.get("depreciationExpense") else APIHelper.SKIP
        other_expenses = None
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'depreciation_expense={(self.depreciation_expense if hasattr(self, "depreciation_expense") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'depreciation_expense={(self.depreciation_expense if hasattr(self, "depreciation_expense") else None)!s}, '
