...
class CryptocurrencyTaxStatementList1(object):

    """Implementation of the 'Cryptocurrency Tax Statement list1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CryptocurrencyTaxStatementList1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('gainsAndLosses') is not None:
