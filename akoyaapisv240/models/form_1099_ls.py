...
class Form1099LS(object):

    """Implementation of the 'Form 1099-LS' model.
    ...
    Attributes:
        ...
        payment (float): Box 1, Amount paid to payment recipient
        sale_date (date): Box 2, Date of sale
        issuer_name (str): Issuer's name
        contact_name_address (NameAddressAndPhone): Acquirer's information
            contact name, street address, city or town, state or province,
            country, ZIP or foreign postal code, and telephone no. (If
            different from ACQUIRER)
    ...
    _names = {
        ...
        "contact_name_address": 'contactNameAddress'
    }
    ...
    def __init__(self,
        ...
        """Constructor for the Form1099LS class"""
        ...
        if links is not APIHelper.SKIP:
            self.links = links 
        if policy_number is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        sale_date = dateutil.parser.parse(dictionary.get('saleDate')).date() if dictionary.get('saleDate') else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'sale_date={(self.sale_date if hasattr(self, "sale_date") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'sale_date={(self.sale_date if hasattr(self, "sale_date") else None)!s}, '
