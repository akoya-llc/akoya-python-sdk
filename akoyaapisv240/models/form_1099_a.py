...
class Form1099A(object):

    """Implementation of the 'Form 1099-A' model.
    ...
    Attributes:
        ...
        principal_balance (float): Box 2, Balance of principal outstanding
        fair_market_value (float): Box 4, Fair market value property
    ...
    def __init__(self,
                 ...
                 date_of_acquisition=APIHelper.SKIP,
        ...
        if date_of_acquisition is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        date_of_acquisition = dateutil.parser.parse(dictionary.get('dateOfAcquisition')).date() if dictionary.get('dateOfAcquisition') else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'date_of_acquisition={(self.date_of_acquisition if hasattr(self, "date_of_acquisition") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'date_of_acquisition={(self.date_of_acquisition if hasattr(self, "date_of_acquisition") else None)!s}, '
