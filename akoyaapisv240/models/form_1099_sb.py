...
class Form1099SB(object):
    ...
    Attributes:
        ...
        surrender_amount (float): Box 2, Surrender amount
        contact_name_address (NameAddressAndPhone): Issuer's information
    ...
    _names = {
        ...
        "contract_investment": 'contractInvestment',
    ...
    def __init__(self,
        ...
        if contract_investment is not APIHelper.SKIP:
            self.contract_investment = contract_investment 
        if surrender_amount is not APIHelper.SKIP:
