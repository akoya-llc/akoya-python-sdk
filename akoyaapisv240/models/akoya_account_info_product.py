...
class AkoyaAccountInfoProduct(object):
    ...
    Attributes:
        accounts (List[DepositAccountInfo | LoanAccountInfo | LocAccountInfo |
            InvestmentAccountInfo | InsuranceAccountInfo | AnnuityAccountInfo]
            | None): An array of accounts with entity types dependent on the
            account type (deposit, investment, loan, line of credit, annuity
            or insurance)
