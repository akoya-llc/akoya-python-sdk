...
class Form1095B(object):

    """Implementation of the 'Form 1095-B' model.
    ...
    Attributes:
        ...
        origin_of_health_coverage_code (str): Box 8, Enter letter identifying
    ...
    _names = {
        ...
        "error": 'error',
        "links": 'links',
        "responsible_date_of_birth": 'responsibleDateOfBirth',
    ...
    def __init__(self,
        ...
        if links is not APIHelper.SKIP:
            self.links = links 
        if responsible_date_of_birth is not APIHelper.SKIP:
            self.responsible_date_of_birth = responsible_date_of_birth 
        if origin_of_health_coverage_code is not APIHelper.SKIP:
            self.origin_of_health_coverage_code = origin_of_health_coverage_code 
        if employer is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        origin_of_health_coverage_code = dictionary.get("originOfHealthCoverageCode") if dictionary.get("originOfHealthCoverageCode") else APIHelper.SKIP
        employer = TaxParty.from_dictionary(dictionary.get('employer')) if 'employer' in dictionary.keys() else APIHelper.SKIP
