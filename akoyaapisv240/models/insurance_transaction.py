...
class InsuranceTransaction(object):

    """Implementation of the 'insuranceTransaction' model.
    ...
    Attributes:
        ...
        transaction_type (InsuranceTransactionType): InsuranceTransaction Type
    ...
    def __init__(self,
        ...
        """Constructor for the InsuranceTransaction class"""
