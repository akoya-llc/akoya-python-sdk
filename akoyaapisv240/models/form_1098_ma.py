...
class Form1098Ma(object):
    ...
    Attributes:
        ...
        total_mortgage_payments (float): Box 1, Total State HFA (Housing
            Finance Agency) and homeowner mortgage payments
    ...
    _names = {
        ...
        "total_mortgage_payments": 'totalMortgagePayments',
        "mortgage_assistance_payments": 'mortgageAssistancePayments',
        "homeowner_mortgage_payments": 'homeownerMortgagePayments'
    }
    ...
    def __init__(self,
        ...
        if total_mortgage_payments is not APIHelper.SKIP:
            self.total_mortgage_payments = total_mortgage_payments 
        if mortgage_assistance_payments is not APIHelper.SKIP:
