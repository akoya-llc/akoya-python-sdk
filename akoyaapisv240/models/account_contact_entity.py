...
from akoyaapisv240.models.delivery_address_details import DeliveryAddressDetails
...
class AccountContactEntity(object):
    ...
    Attributes:
        ...
        addresses (List[DeliveryAddressDetails]): The model property of type
            List[DeliveryAddressDetails].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('addresses') is not None:
            addresses = [DeliveryAddressDetails.from_dictionary(x) for x in dictionary.get('addresses')]
        else:
            addresses = APIHelper.SKIP
        telephones = None
