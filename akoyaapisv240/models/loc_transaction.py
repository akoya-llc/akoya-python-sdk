...
from akoyaapisv240.models.payment_details import PaymentDetails


class LocTransaction(object):

    """Implementation of the 'LocTransaction' model.
    ...
    Attributes:
        ...
        reference_transaction_id (str): Akoya ensures that this field is
            ...
            transaction.
        status (TransationStatusEnum): AUTHORIZATION, MEMO, PENDING, or POSTED
        ...
        transaction_type (LocTransactionTypeEnum): LocTransaction Type
    ...
    def __init__(self,
        ...
        """Constructor for the LocTransaction class"""
