...
class InvestmentsDetails(object):

    """Implementation of the 'InvestmentsDetails' model.

    Attributes:
        accounts (List[InvestmentBalanceInfo | DepositBalanceInfo |
            LoanBalanceInfo | LocBalanceInfo | InsuranceBalanceInfo |
