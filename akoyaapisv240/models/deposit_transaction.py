...
class DepositTransaction(object):

    """Implementation of the 'depositTransaction' model.
    ...
    Attributes:
        ...
        transaction_type (DepositTransactionTypeEnum): DepositTransaction Type
    ...
    def __init__(self,
        ...
        """Constructor for the DepositTransaction class"""
