...
class TaxBetaController(BaseController):

    """A Controller to access Endpoints in the akoyaapisv240 API."""
    def __init__(self, config):
        super(TaxBetaController, self).__init__(config)
    ...
    def tax_forms_search(self,
        ...
        Args:
            ...
            x_akoya_interaction_type (InteractionTypeEnum, optional):
                Identifies whether the customer is present (USER) or it is a
                BATCH operation. Case-insensitive.
            accept (List[MediaTypeEnum], optional): Use the [Accept HTTP
                request
    ...
    def get_tax_form(self,
        ...
        Returns:
            TaxStatement: Response from the API. The document image or
